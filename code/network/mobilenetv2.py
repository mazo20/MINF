...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, output_stride=8, width_mult=1.0, inverted_residual_setting=None, round_nearest=8):
        ...
        for t, c, n, s in inverted_residual_setting:
            ...
            for i in range(n):
                if i==0:
                    features.append(InvertedResidual(input_channel, output_channel, stride, previous_dilation, expand_ratio=t))
                else:
                    features.append(InvertedResidual(input_channel, output_channel, 1, dilation, expand_ratio=t))
